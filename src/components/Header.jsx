...
const Header = () => {
  ...
  return (
    <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16'>
        ...
        <div className='flex items-center gap-8'>
          ...
          <div className='relative'>
            <motion.img
              ...
              className="w-10 min-w-[480] h-10 min-h-[40px] drop-shadow-xl rounded-full cursor-pointer"
              alt='userprofile'
              onClick={login}
            />
            {
              isMenu && (
                <motion.div
                  ...
                  className='w-40 bg-gray-50 shadow-x1 rounded-lg flex flex-col absolute top-12 right-0 overflow-hidden'>
                  {user && user.email === "scm.minaungpaing@gmail.com" && (
                    <Link to={"/createItem"}>
      ...
      {/* mobile */}
      <div className='flex md:hidden item-center justify-between w-full h-full'>
        <Link className='flex items-center gap-2' to={'/'}>
          <img src={Logo} className="w-8 object-cover" alt='logo' />
          <p className='text-headingColor text-xl font-bold'>City</p>
        </Link>
            ...
            isMenu && (
              <motion.div
                ...
                <ul
                  ...
                  <li className='px-4 py-2 text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer'>Service</li>
                </ul>
