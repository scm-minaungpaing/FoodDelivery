    ...
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
      <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
        ...
        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed incidunt consectetur
          voluptas mollitia sunt perferendis aliquam natus accusantium,
          odio qui cumque aperiam deleniti illum et quos. Voluptate sunt nulla provident?
        </p>
